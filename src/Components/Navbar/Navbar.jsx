...
import weeding from "../../assets/wedding.jpg"
...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li>
        <Link  className=" hover:text-red-300" to="/events"> Events Packages</Link>
      </li>
      <li>
        <Link className=" hover:text-red-300" to="/about"> About Us </Link>
      </li>
      <li>
        <Link className=" hover:text-red-300" to="/contact"> Contact Us</Link>
      </li>
  ...
  return (
    <div>
      <div className="navbar   bg-base-100  border shadow-sm text-black  ">
